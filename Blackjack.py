...
# Makes the purely decorative title
def intro():
    print(".------.------.------.------.------.------.------.------.------.")
...
#--------------------------------------------------------------------
# OUTPUT: Print the decorative cards
#--------------------------------------------------------------------
...
#-------------------------------------------------------------------
    ...
    YN = str(input("Do You Want to Play y/n:"))
    
    # sStarts the game
    while 'yes'.startswith(YN.lower()): 
    ...
    # If the player says no at ether of the "do you want to play" questions
